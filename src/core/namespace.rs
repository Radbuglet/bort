...
use crate::util::{unpoison, unwrap_error, FxHashMap, NOT_ON_MAIN_THREAD_MSG};
...
impl<T> NOptRefCell<T> {
    ...
    pub fn set_namespace_ref(&self, token: &impl ExclusiveToken<T>, namespace: Option<Namespace>) {
