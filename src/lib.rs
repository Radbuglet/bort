...
impl<T: 'static> Storage<T> {
    ...
    pub fn insert_hazardous(&self, entity: Entity, value: T) -> Option<T> {
        ALIVE.with(|slots| {
    ...
    #[inline(always)]
    pub fn insert(&self, entity: &OwnedEntity, value: T) -> Option<T> {
        self.insert_hazardous(entity.entity(), value)
    }

    #[inline(always)]
    pub fn insert_shared(&self, entity: Entity, value: T) -> Option<T>
    where
        T: SharedAccess,
    {
        self.insert_hazardous(entity, value)
    }
    ...
    pub fn remove_hazardous(&self, entity: Entity) -> Option<T> {
    ...
    #[inline(always)]
    pub fn remove(&self, entity: &OwnedEntity) -> Option<T> {
        self.remove_hazardous(entity.entity())
    }

    #[inline(always)]
    pub fn remove_shared(&self, entity: Entity) -> Option<T>
    where
        T: SharedAccess,
    {
        self.remove_hazardous(entity)
    }
    ...
    #[inline(always)]
    pub fn try_get_hazardous(&self, entity: Entity) -> Option<CompRef<T>> {
        self.try_get_slot(entity)
            .map(|slot| Ref::map(slot.borrow(), |v| v.as_ref().unwrap()))
    }

    #[inline(always)]
    pub fn try_get<'a>(&self, entity: &'a OwnedEntity) -> Option<Ref<'a, T>> {
        self.try_get_hazardous(entity.entity())
    }

    #[inline(always)]
    pub fn try_get_shared(&self, entity: Entity) -> Option<CompRef<T>>
    where
        T: SharedAccess,
    {
        self.try_get_hazardous(entity)
    }

    // === `try_get_mut` === //

    #[inline(always)]
    pub fn try_get_mut_hazardous(&self, entity: Entity) -> Option<CompMut<T>> {
        self.try_get_slot(entity)
            .map(|slot| RefMut::map(slot.borrow_mut(), |v| v.as_mut().unwrap()))
    }

    #[inline(always)]
    pub fn try_get_mut<'a>(&self, entity: &'a OwnedEntity) -> Option<RefMut<'a, T>> {
        self.try_get_mut_hazardous(entity.entity())
    }

    #[inline(always)]
    pub fn try_get_mut_shared(&self, entity: Entity) -> Option<CompMut<T>>
    where
        T: SharedAccess,
    {
        self.try_get_mut_hazardous(entity)
    }

    // === `get` === //

    #[inline(always)]
    pub fn get_hazardous(&self, entity: Entity) -> CompRef<T> {
        Ref::map(self.get_slot(entity).borrow(), |v| v.as_ref().unwrap())
    }

    #[inline(always)]
    pub fn get<'a>(&self, entity: &'a OwnedEntity) -> Ref<'a, T> {
        self.get_hazardous(entity.entity())
    }

    #[inline(always)]
    pub fn get_shared(&self, entity: Entity) -> CompRef<T>
    where
        T: SharedAccess,
    {
        self.get_hazardous(entity)
    }

    // === `get_mut` === //

    #[inline(always)]
    pub fn get_mut_hazardous(&self, entity: Entity) -> CompMut<T> {
        RefMut::map(self.get_slot(entity).borrow_mut(), |v| v.as_mut().unwrap())
    }

    #[inline(always)]
    pub fn get_mut<'a>(&self, entity: &'a OwnedEntity) -> RefMut<'a, T> {
        self.get_mut_hazardous(entity.entity())
    }

    #[inline(always)]
    pub fn get_mut_shared(&self, entity: Entity) -> CompMut<T>
    where
        T: SharedAccess,
    {
        self.get_mut_hazardous(entity)
    }
...
impl Entity {
    ...
    pub fn insert_hazardous<T: 'static>(self, comp: T) -> Option<T> {
        storage::<T>().insert_hazardous(self, comp)
    }
    ...
    where
        T: SharedAccess,
    {
        storage::<T>().insert_shared(self, comp)
    }

    pub fn remove_hazardous<T: 'static>(self) -> Option<T> {
        storage::<T>().remove_hazardous(self)
    }
    ...
    where
        T: SharedAccess,
    {
        storage::<T>().remove_shared(self)
    }

    pub fn try_get_hazardous<T: 'static>(self) -> Option<CompRef<T>> {
        storage::<T>().try_get_hazardous(self)
    }
    ...
    where
        T: SharedAccess,
    {
        storage::<T>().try_get_shared(self)
    }

    pub fn try_get_mut_hazardous<T: 'static>(self) -> Option<CompMut<T>> {
        storage::<T>().try_get_mut_hazardous(self)
    }
    ...
    where
        T: SharedAccess,
    {
        storage::<T>().try_get_mut_shared(self)
    }

    pub fn get_hazardous<T: 'static>(self) -> CompRef<T> {
        storage::<T>().get_hazardous(self)
    }
    ...
    where
        T: SharedAccess,
    {
        storage::<T>().get_shared(self)
    }

    pub fn get_mut_hazardous<T: 'static>(self) -> CompMut<T> {
        storage::<T>().get_mut_hazardous(self)
    }
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        ALIVE.with(|alive| {
            ...
            if let Some(comp_list) = alive.borrow().get(self).copied() {
                ...
                if let Some(label) = self.try_get_hazardous::<DebugLabel>() {
                    builder.field(&label);
                }
...
impl OwnedEntity {
    ...
    pub fn with_debug_label<L: AsDebugLabel>(self, label: L) -> Self {
        if cfg!(debug_assertions) {
            self.insert(DebugLabel::from(label));
        }
        self
    }
